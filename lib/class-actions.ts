...
export const CLASS_ACTIONS: Record<string, ClassActionDef> = {
  berserker: {
    ...
    classId: "berserker",
    name: "Ярость Бати",
    shortDescription: "Следующий «тяжёлый прогон» → ×1.3 поинтов",
    longDescription:
      "Берсерк ярится. На следующем «прошёл» если поставишь галку «Тяжёлый прогон» (макс. сложность ИЛИ Souls-like / Hardcore-by-design) — поинты умножаются на 1.3. Если не поставишь — бафф сгорит впустую.",
