...
export const CLASS_ACTIONS: Record<string, ClassActionDef> = {
  ...
  loreman: {
    ...
    longDescription:
      "На следующем ролле игры можешь покрутить gamegauntlets дважды и вписать тот тайтл, который понравился больше. По чести — мы не проверяем, как ты крутишь.",
  ...
  alchemist: {
    ...
    classId: "alchemist",
    name: "Алхимия",
    shortDescription: "3 одинаковых баффа → 1 случайный артефакт",
    longDescription:
      "Кинь в котёл 3 одинаковых расходника или экипировки — на выходе будет случайный артефакт. Алхимия — это вера в случай.",
