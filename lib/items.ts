...
export const ITEMS: ItemDef[] = [
  ...
  },
  {
    id: "rotten_vape",
    name: "Гнилой вейп",
    description: "Затянулся дрянью — и как-то взбодрился. +1 ход.",
    category: "CONSUMABLE", rarity: "COMMON",
    iconKey: "vape", effectKey: "add_energy_1",
    charges: 1, rollWeight: 14,
  },
  {
    id: "balanda",
  ...
  },
  {
    ...
    description: "На дне что-то ещё шевелится. +1 ход.",
    category: "CONSUMABLE", rarity: "COMMON",
    iconKey: "pot", effectKey: "add_energy_1",
    charges: 1, rollWeight: 14,
  },
  {
    id: "chebupizza",
  ...
  },
  {
    ...
    description: "Восемь съел, девятый — урок жизни. +25 опыта.",
    category: "CONSUMABLE", rarity: "COMMON",
    iconKey: "nuggets", effectKey: "gain_exp_25",
    charges: 1, rollWeight: 13,
  },
  {
    id: "sold_cheap",
    name: "Продал подешевле",
    description: "Прогадал, но мудрость осталась. +25 опыта.",
    category: "CONSUMABLE", rarity: "COMMON",
    iconKey: "coin", effectKey: "gain_exp_25",
    charges: 1, rollWeight: 13,
  },
  {
    id: "bought_expensive",
  ...
  // ----- Косметика колеса (одёжная — выпадает с рулетки) -----
  {
    id: "sleeveless_hoodie",
    name: "Худи безрукавка",
    description: "Худи, которому ампутировали рукава. Косметика.",
    category: "COSMETIC", rarity: "COMMON",
    iconKey: "cosmetic_clothes", rollWeight: 12,
  },
  {
    id: "cap_backwards",
    name: "Кепка назад",
    description: "Кепка, надетая задом наперёд. Дерзко. Косметика.",
    category: "COSMETIC", rarity: "COMMON",
    iconKey: "cosmetic_cap", rollWeight: 12,
  },
  {
    id: "hood_cap",
    name: "Шапка капюшон",
    description: "Шапка и капюшон в одном лице. Косметика.",
    category: "COSMETIC", rarity: "COMMON",
    iconKey: "cosmetic_hood", rollWeight: 12,
  },
  {
    id: "punish_tshirt",
    name: "Футболка Punish",
    description: "Чёрная футболка с грозной надписью. Косметика-титул.",
    category: "COSMETIC", rarity: "RARE",
    iconKey: "cosmetic_clothes", rollWeight: 6,
  },
  {
    id: "gorgonit_hoodie",
    name: "Худи Горгонит",
    description: "Худи с мордой неведомой твари. Косметика.",
    category: "COSMETIC", rarity: "RARE",
    iconKey: "cosmetic_clothes", rollWeight: 6,
  },
  {
    ...
    description: "Легендарные ботинки, видавшие дно. Косметика.",
    category: "COSMETIC", rarity: "RARE",
    iconKey: "cosmetic_boots", rollWeight: 6,
  },
  ...
  },
  {
    ...
    description: "Любовь к Готэму и пятно неизвестного происхождения. Косметика-титул.",
    category: "COSMETIC", rarity: "RARE",
    iconKey: "cosmetic_clothes", rollWeight: 0,
  },
  {
    id: "not_bad_days_hoodie",
    name: "Зип худи Not Bad Days",
    description: "Дни и правда не так плохи. Косметика.",
    category: "COSMETIC", rarity: "EPIC",
    iconKey: "cosmetic_clothes", rollWeight: 0,
  },
  {
    id: "chakhlik_hat",
    name: "Шляпа Чахлика",
    description: "Шляпа двухсотлетнего отшельника. Косметика.",
    category: "COSMETIC", rarity: "EPIC",
    iconKey: "cosmetic_hat", rollWeight: 0,
  },
  {
    id: "vasilisa_perdak",
